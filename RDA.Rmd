...
13a Testing the significance of CCA axes (at least the first two or three should present a significant p value)
...
13b Testing the significance of terms (environmental variables)
Hint Argument "step" gives the minimal number of permutations requested 
to assess if the F value of a test is obviously significant or not
