...
df1a <- imputePCA(df1,ncp=2, scale = TRUE, method = c("Regularized","EM"), 
...
df2a <- imputePCA(df2, ncp=2, scale = TRUE, method = c("Regularized","EM"), 
                      row.w = NULL, ind.sup=NULL,quanti.sup=NULL,quali.sup=NULL,
                      coeff.ridge = 1, threshold = 1e-06, seed = NULL, nb.init = 1,  
                      maxiter = 1000)
...
new_channel2 <- select(new_channel,
                       ...
                       completeObs.Limo, completeObs.NAN_Am, completeObs.NAtemp, completeObs.NASatO2,
                       )
