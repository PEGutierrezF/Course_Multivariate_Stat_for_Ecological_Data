...
```{r}
plot(varp, digits = 2, Xnames = c('Enviromental factors', 'Vegetation', "Season"),bg = c('navy', 'tomato', "lightblue"))
title('Variation partitioning by partial RDA')
...
http://rstudio-pubs-static.s3.amazonaws.com/161192_62db20511abe4a33a09a2f4043d6a868.html
