...
Paso 7.  Vamos a poner Habitat, Site y Periodo en el grafico. 
...
Paso 8.  Extraer las cordenadas de los Axis del nmds.
...
Paso 9.  Unir los datos de Habitat, Site y Periodo a mi nueva dataframe (i.e., data.scores)
...
Paso 10.  Extraer las cordenadas de las especies y ponerlas en una nueva matrix.
...
Paso 11.  Vamos hacer graficos bonitos en ggplot2.
Solo Especies.
...
Paso 12.  Vamos a poner etiquetas. En este caso solo Habitats y Periordo
...
Paso 14.  Graficos de Publicacion.
